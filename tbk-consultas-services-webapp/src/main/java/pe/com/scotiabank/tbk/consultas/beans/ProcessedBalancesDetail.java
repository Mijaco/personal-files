...
//@XmlRootElement(name = "ProcessedBalancesDetail", namespace = "http://response.jaxws.tbk.scotiabank.com.pe")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ProcessedBalancesDetail", namespace = "http://message.generalbalancesservices.tbk.scotiabank.com.pe")

public class ProcessedBalancesDetail implements Body, Serializable
{
    private static final long serialVersionUID = 3222884724538790569L;
    ...
    public ProcessedBalancesDetail()
    {
    }

    public ProcessedBalancesDetail(String output)
    {
    ...
    public ProcessedBalancesDetail(String docCountryAcceptant, String docTypeAcceptant, String docNroAcceptant, String nameAcceptant, String cantTotDocSoles, String impTotDocSoles,
    ...
    {
        StringBuilder builder = new StringBuilder();
        builder.append("ProcessedBalancesDetail [docCountryAcceptant=");
        builder.append(docCountryAcceptant);
        builder.append(", docTypeAcceptant=");
        builder.append(docTypeAcceptant);
        builder.append(", docNroAcceptant=");
