...
import pe.com.scotiabank.tbk.consultas.beans.OutstandingBalancesDetail;
import pe.com.scotiabank.tbk.util.beans.Response;
import pe.com.scotiabank.tbk.util.beans.Status;

@XmlRootElement(name = "BalancesFactoringPendingResponse", namespace = "http://message.generalbalancesservices.tbk.scotiabank.com.pe")
public class BalancesFactoringPendingResponse extends Response
{
    private static final long serialVersionUID = 740501486954344026L;
    ...
    private OutstandingBalancesDetail[] outstandingBalancesDetails;

    public BalancesFactoringPendingResponse()
    {
    }

    public BalancesFactoringPendingResponse(Status status)
    {
        super(status);
    }

    public BalancesFactoringPendingResponse(String code, String message)
    {
        super(code, message);
    }
    ...
    @XmlElementWrapper(name = "outstandingBalancesDetails")
    @XmlElement(name = "outstandingBalancesDetail")
    public OutstandingBalancesDetail[] getOutstandingBalancesDetails()
    {
        return outstandingBalancesDetails;
    }

    public void setOutstandingBalancesDetails(OutstandingBalancesDetail[] outstandingBalancesDetails)
    {
        this.outstandingBalancesDetails = outstandingBalancesDetails;
    }
    ...
    public String toString()
    {
        ...
        builder.append("BalancesFactoringPendingResponse [cantTotDocSoles=");
        ...
        builder.append(acceptantAmounts);
        builder.append(", outstandingBalancesDetails=");
        builder.append(Arrays.toString(outstandingBalancesDetails));
        builder.append("]");
