...
@XmlElement(value= "DataDetailPaymentsReceived")
public class DataDetailPaymentsReceived implements Reportable
{
    ...
    public DataDetailPaymentsReceived(String trama)
    {
    ...
    public DataDetailPaymentsReceived()
    {
        super();
    }
